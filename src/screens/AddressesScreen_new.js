...
import { View, Text, FlatList, StyleSheet, TouchableOpacity, ActivityIndicator, Alert, ScrollView, Animated, Dimensions, StatusBar } from 'react-native';
    ...
    >
        ...
        onPress={() => {
          if (selectMode) {
            if (navigation.canGoBack && navigation.canGoBack()) {
              navigation.navigate({
                name: returnTo || 'ProductDetails',
                params: { selectedAddress: item },
                merge: true,
              });
              navigation.goBack();
            } else {
              navigation.navigate(returnTo || 'ProductDetails', { selectedAddress: item });
            }
            return;
          }
      ...
      >
        ...
        <View style={styles.cardHeader}>
          ...
          {selectMode ? (
            <CheckCircle size={20} color={BRAND_COLOR} />
          ) : (
        ...
        {loading ? (
          ...
          <View style={styles.emptyContainer}>
            ...
            <TouchableOpacity
              ...
              onPress={() => {
                if (selectMode) {
                  navigation.navigate('AddAddress', { returnTo: returnTo || 'ProductDetails' });
                  return;
                }
