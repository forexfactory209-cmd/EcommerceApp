...
const TrackOrderScreen = () => {
  ...
  // Distinct default colors for each status; active one will use BRAND_COLOR
  const filterOptions = [
    { id: 'all', label: 'All Orders', color: '#E5E7EB', icon: <Package size={18} color="#111827" /> },
    { id: 'pending', label: 'Pending', color: '#FEF3C7', icon: <Clock size={18} color={WARNING_COLOR} /> },
    { id: 'shipped', label: 'Shipped', color: '#DBEAFE', icon: <Truck size={18} color={INFO_COLOR} /> },
    { id: 'delivered', label: 'Delivered', color: '#DCFCE7', icon: <CheckCircle size={18} color={SUCCESS_COLOR} /> },
    { id: 'canceled', label: 'Canceled', color: '#FEE2E2', icon: <AlertCircle size={18} color={ERROR_COLOR} /> },
  ];
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <Animated.View style={[styles.quickActionsContainer, { opacity: fadeAnim }]}>
        {renderQuickAction({
          icon: <Phone size={20} color={BRAND_COLOR} />,
          label: 'Support',
          color: BRAND_COLOR,
          onPress: () => {},
        })}
        {renderQuickAction({
          icon: <Download size={20} color={BRAND_COLOR} />,
          label: 'Invoice',
          color: BRAND_COLOR,
          onPress: () => {},
        })}
        {renderQuickAction({
          icon: <Share2 size={20} color={BRAND_COLOR} />,
          label: 'Share',
          color: BRAND_COLOR,
          onPress: () => {},
        })}
